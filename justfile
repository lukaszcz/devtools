...
symlink := "false"
scripts := "brsync.sh cpconfig.sh git-rm-branches.sh mkwt.sh pm-dep.sh pm-fetch.sh pm-init.sh prlog.sh prsync.sh rmwt.sh tmux.sh tmux-apply-layout.sh pm.sh sandbox.sh"
